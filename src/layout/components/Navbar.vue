<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <!-- <el-dropdown-item @click.native="getGoogleCode">
            <span>生成Google码</span>
          </el-dropdown-item> -->
    ...
    <!-- 生成Google二维码-->
    <el-dialog class="qrcode-dialog" title="请扫码" :visible.sync="qrCodeBox" width="500px" append-to-body>
...
export default {
  data() {
    return {
      qrCodeBox: false,
      defaultImg:"@/assets/logo/logo.png"
    }
  },
  components: {
    Breadcrumb,
  ...
  methods: {
    ...
    getGoogleCode(){
      ...
      this.$nextTick(_=>{
        ...
        let qrcode = new QRCode(qrcodeDemo, {
          width: 200,  
          height: 200, // 高度  
          text: str, // 二维码内容  
