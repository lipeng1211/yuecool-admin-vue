...
<template>
	<div class="app-container">
		...
		<el-table v-loading="loading" :data="packetList" @selection-change="handleSelectionChange">
			...
			<el-table-column label="祝福语" align="center" prop="greetings" width="200"  :show-overflow-tooltip="true"/>
			<el-table-column label="发送时间" align="center" prop="sendTime" width="180">
				<template slot-scope="scope">
					<span>{{scope.row.sendTime }}</span>
				</template>
			</el-table-column>
			<el-table-column label="个人红包/群红包" align="center" width="120">
				<template slot-scope="scope">
					<span v-if="scope.row.groupGid">群 红 包</span>
					<span v-else="!scope.row.groupGid">个人红包</span>
				</template>
			</el-table-column>
			<el-table-column label="红包类型" align="center" width="120">
				<template slot-scope="scope">
					<span v-for="(it,index) in redpack_type" :key="index">
						<span style="color: red;" v-if="scope.row.type==it.dictValue">{{it.dictLabel}}</span>
					</span>
				</template>
			</el-table-column>
			<el-table-column label="红包个数" align="center" prop="count" />
			<el-table-column label="已领个数" align="center" prop="receiveCount" />
			<el-table-column label="红包金额" align="center" prop="money" />
			<el-table-column label="红包剩余" align="center" prop="over" />
			...
			<el-table-column label="领取状态" align="center" prop="status">
				...
				<template slot-scope="scope">
					<span v-if="scope.row.over > 0" style="color: #018EF8;">发 出</span>
					<span v-else style="color: #018EF8;">已领完</span>
				</template>
			</el-table-column>
			<!-- <el-table-column label="领取该红包的 userId 字符串" align="center" prop="userIds" /> -->
			<!-- <el-table-column label="红包唯一标识" align="center" prop="orderId" /> -->
			<el-table-column label="口令" align="center" prop="word" width="120" />
			<el-table-column label="封面url" align="center" prop="coverUrl" width="120" />
