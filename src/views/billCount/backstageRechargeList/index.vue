...
<template>
	<div class="app-container">
		...
		<el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
			...
			<el-table-column label="充值记录ID" align="center" prop="id" width="100"  :show-overflow-tooltip="true"/>
			...
			<el-table-column label="收支类型" align="center" prop="changeType">
				<template slot-scope="scope">
					<span v-for="dict in shouzhiType" :key="dict.dictValue">
						<span style="color:#46A6FF"
							v-if="dict.dictValue*1 == scope.row.changeType">{{dict.dictLabel}}</span>
					</span>
				</template>
			</el-table-column>
			...
			<el-table-column label="到账时间" align="center" prop="time" width="180">
				<template slot-scope="scope">
