<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否显示" align="center" prop="deleted">
        <template slot-scope="scope">
          <span v-if="scope.row.deleted == 0">是</span>
          <span v-if="scope.row.deleted == 1">否</span>
        </template>
      </el-table-column>  
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否显示" prop="deleted">
...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory, exportCategory } from "@/api/system/lecturerCategory";
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有讲师分类数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
