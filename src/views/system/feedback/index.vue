<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="feedbackList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="反馈内容" align="center" prop="feedbackMessage" />
      <el-table-column label="反馈图片" align="center" prop="image" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="反馈内容" prop="feedbackMessage">
          <el-input v-model="form.feedbackMessage" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="反馈图片" prop="image">
          <el-input v-model="form.image" placeholder="请输入反馈图片" />
        </el-form-item>
        <el-form-item label="用户id" prop="userId">
