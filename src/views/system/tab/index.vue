  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="链接地址" prop="addressUrl">
        <el-input
          v-model="queryParams.addressUrl"
          placeholder="请输入链接地址"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-table-column label="图片" align="center">
        <template slot-scope="scope">
          <el-image  style="width: 100px; height: 100px"
            :src="tabList[scope.$index].imgUrl" fit="scale-down" @click="watch(scope.row)"></el-image>
        </template>
      </el-table-column>
...
<script>
import {listTab, getTab, delTab, addTab, updateTab, exportTab, uploadUrl} from "@/api/system/tab";
import {put, uploadObject} from "@/api/app";
import {uploadPath} from "@/api/system/upload";
...
export default {
  ...
  methods: {
    ...
    uploadSectionFile(param) {
      ...
      // uploadObject("guoxuerongmei",form,null)
