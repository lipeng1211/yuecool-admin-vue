<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="1 单雷 2连环雷" prop="numType">
        <el-select v-model="queryParams.numType" placeholder="请选择1 单雷 2连环雷" clearable size="small">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:redEnvelopeConfigGroup:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:redEnvelopeConfigGroup:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:redEnvelopeConfigGroup:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:redEnvelopeConfigGroup:export']"
        >导出</el-button>
      </el-col>
	  <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="redEnvelopeConfigGroupList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="1 单雷 2连环雷" align="center" prop="numType" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="1 单雷 2连环雷" prop="numType">
          <el-select v-model="form.numType" placeholder="请选择1 单雷 2连环雷">
            <el-option label="请选择字典生成" value="" />
          </el-select>
        </el-form-item>
        <el-form-item label="金额1" prop="amountOne">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listRedEnvelopeConfigGroup(this.queryParams).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateRedEnvelopeConfigGroup(this.form).then(response => {
            ...
            addRedEnvelopeConfigGroup(this.form).then(response => {
              if (response.code === 200) {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有红包群配置数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return exportRedEnvelopeConfigGroup(queryParams);
        }).then(response => {
