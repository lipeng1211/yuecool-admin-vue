<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="orderNum" label="分类级别" width="200">
        <template slot-scope="scope">
          <span v-if="scope.row.orderNum == 0">顶级分类</span>
          <span v-if="scope.row.orderNum != 0 && scope.row.children.length > 0">一级分类</span>
          <span v-if="scope.row.orderNum != 0 && scope.row.children.length == 0">二级分类</span>
        </template>
      </el-table-column>
