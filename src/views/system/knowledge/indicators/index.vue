<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="indicatorsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程ID" align="center" prop="address" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="课程ID" prop="address">
          <el-input v-model="form.address" placeholder="请输入课程ID" />
        </el-form-item>
        <el-form-item label="轮播名称" prop="name">
...
<script>
import { listIndicators, getIndicators, delIndicators, addIndicators, updateIndicators, exportIndicators } from "@/api/system/knowledge/indicators";
