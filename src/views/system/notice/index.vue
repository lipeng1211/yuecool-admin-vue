  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" prop="isTop"  >
        <template slot-scope="scope">
        <el-button type="success" size="mini" @click="systemNotification(scope.row)">发送系统通知</el-button>
        </template>
      </el-table-column>
...
<script>
import { listNotice, getNotice, delNotice, addNotice, updateNotice, exportNotice, sendOutSysNotice } from "@/api/system/notice";
  ...
  methods: {
    ...
    systemNotification(row){
      ...
      this.$confirm('是否确认发送系统通知?', "警告", {
        ...
        sendOutSysNotice(params).then(response => {
          if (response.code === 200) {
