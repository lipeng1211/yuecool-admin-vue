  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="分类" prop="category">
          <el-select v-model="queryParams.teachBlock" placeholder="教学版块" clearable size="small" style="width: 240px">
            <el-option v-for="dict in teachOptions" :key="dict.dictValue" :label="dict.dictLabel" :value="dict.dictValue" />
          </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" width="1000px" zIndex ="1">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="分类" prop="teachBlock">
          <el-select v-model="form.teachBlock" placeholder="教学版块" clearable size="small" style="width: 240px">
            <el-option v-for="dict in teachOptions" :key="dict.dictValue" :label="dict.dictLabel" :value="dict.dictValue" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="费用" prop="brief" v-if="form.charge == '0'">
          <el-input v-model="form.cost" clearable placeholder="请输入费用" size="small" oninput="value=value.replace(/[^\d.]/g,'')" style="width: 240px"/>
        </el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        open: false,
        // 状态字典
        statusOptions:[{dictLabel:'金牌投顾',dictValue:1},{dictLabel:'教学专区',dictValue:2}],
        teachOptions:[{dictLabel:'指标教学',dictValue:1},{dictLabel:'投资必备',dictValue:2},{dictLabel:'战法教学',dictValue:3},{dictLabel:'投资答疑',dictValue:4}],
        // 查询参数
        queryParams: {
        	pageNum: 1,
            pageSize: 10,
