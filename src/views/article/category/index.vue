<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="分类名称" prop="dictType">
      ...
      <el-form-item label="分类标签" prop="dictLabel">
        <el-input
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="资讯分类" align="center" prop="dictLabel" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="排序" prop="dictValue">
          <el-input v-model="form.dictSort" placeholder="请输入数据键值" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除分类编码为"' + dictCodes + '"的数据项?', "警告", {
